...
export const buyTogetherResolver = {
  getSimilarProducts: async (_: any, { productId }: { productId: string }) => {
    const url = `${BASE_URL}/api/catalog_system/pub/products/crossselling/showtogether/${productId}`;
